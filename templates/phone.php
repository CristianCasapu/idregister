...
<div id="idregister-phone" class="idreg">
	<div class="idreg-card idreg-phone">
		<h1><?php p($l->t('Sign in with your phone')); ?></h1>
		<p class="idreg-lead"><?php p($l->t('Open the registration app on your phone, press "Sign in", and point it at this code.')); ?></p>
		<div class="idreg-message" id="idreg-phone-message" role="alert" hidden></div>
		<div class="idreg-qr-frame" id="idreg-phone-frame">
		...
		<div class="idreg-number" id="idreg-phone-number" hidden>
			...
			<div class="idreg-digits" id="idreg-phone-digits" aria-live="polite"></div>
		</div>
		<div class="idreg-progress" id="idreg-phone-progress" hidden><span></span></div>
		<div class="idreg-sub idreg-countdown" id="idreg-phone-countdown"></div>
